...
const fileExtLimiter = (allowedExtArray) => {
  return (req, res, next) => {
    ...
    // console.log("extenstion  ---- ",files.substring(files.indexOf("/")+1, files.indexOf(";")))
    const allowed = allowedExtArray.includes(  '.' + files.substring(files.indexOf('/') + 1, files.indexOf(';')));

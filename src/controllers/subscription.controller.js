// Business
import SubscriptionBusiness from '@/business/subscription.business';
...
const getAll = async (req, res) => {
  try {
    // Business logic
    const data = await SubscriptionBusiness.getAll();
    // Return success
    success(res, data);
  } catch (err) {
    // Return error (if any)
...
const getAllLogged = async (req, res) => {
  try {
    ...
    // Business logic
    const data = await SubscriptionBusiness.getAllLogged(user_id);
    // Return success
    success(res, data);
  } catch (err) {
    // Return error (if any)
